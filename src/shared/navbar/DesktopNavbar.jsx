    ...
    >
      ...
      {subItems && (
        <ul
          ...
          } my-transition absolute z-[99999] -right-[30%] lg:-right-[110%] flex flex-col items-start bg-secondary rounded-md h-fit w-auto lg:w-[180px] ring-1 ring-text-color/20 overflow-hidden *:w-full p-1`}
        >
          {subItems.map((item) => (
            <li key={item.label}>
              <NavLink
